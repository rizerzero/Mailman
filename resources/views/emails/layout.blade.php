...
<title>{!! eval('?>'.Blade::compileString($mailmessage->subject)) !!}</title>
<style type="text/css">
...
<td width="580" style="font-family: sans-serif; font-size: 16px !important; vertical-align: top;" class="eoa_1ga">
            @yield('content')
                    </td>
                  </tr></table>
</td>
            </tr></table>
<div class="footer" style="clear: both; padding-top: 10px; text-align: center; width: 100%; padding-bottom: 100px;">
            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;"><tr>
